			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li><a href="{{ url('/asset/list') }}"><i class="fa fa-circle-o"></i> ครุภัณฑ์</a></li>
							<li><a href="{{ url('/asset-cate/list') }}"><i class="fa fa-circle-o"></i> หมวดครุภัณฑ์</a></li>
							<li><a href="{{ url('/asset-type/list') }}"><i class="fa fa-circle-o"></i> ชนิดครุภัณฑ์</a></li>
							<li><a href="{{ url('/supplier/list') }}"><i class="fa fa-circle-o"></i> ผู้จัดจำหน่าย</a></li>
						</ul>
					</li>													
				</ul>
			</section><!-- /.sidebar -->
